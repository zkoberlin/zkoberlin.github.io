...
| `paul-gateway-v2 /trailyx-preview` | Hub | Lesen | nächste und letzte Reise sowie Jahreswerte | Google-Authentifizierung; minimiertes Schema; internes Service Binding und separates Integrationssecret; keine Notizen, Fotos oder Reiseliste | **Niedrig:** unauthentifizierten Zugriff und Schema bei Releases erneut prüfen. |
