/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 59bd85cfff1c9dca6f0b807e28f5ef07)
// Runtime types generated with workerd@1.20260825.1 2026-08-26 
interface __BaseEnv_Env {
	ALLOWED_GOOGLE_EMAIL: string;
	HUB_PREVIEW_SECRET: string;
	BACKEND: Fetcher /* kalender-proxy */;
	TRAILYX: Fetcher /* trailyx-api-dev */;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ALLOWED_GOOGLE_EMAIL" | "HUB_PREVIEW_SECRET">> {}
}
